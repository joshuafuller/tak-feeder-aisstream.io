...
const typeFilter = (typeof process.env.TYPE_FILTER !== 'undefined') ? process.env.TYPE_FILTER.split(",") : [];
...
module.exports.ais2cot = (item,stale) => {
    ...
    if ((item.hasOwnProperty('lat')) && (item.hasOwnProperty('lon'))) {
        ...
        if (typeof(item["type"]) !== "undefined") {
            ...
            if ((typeFilter.length == 0) | (typeFilter.includes(aisType))) return result;
        }
    }
}
